    ...
    ($($T:ty),*) => {
        $(
            impl AscType for $T {
                ...
                fn from_asc_bytes(asc_obj: &[u8], _api_version: &$crate::semver::Version) -> Result<Self, AscError> {
...
macro_rules! impl_asc_type_struct {
    ($struct_name:ident; $($field_name:ident => $field_type:ty),*) => {
        impl $crate::asc::base::AscType for $struct_name  {
            ...
            fn from_asc_bytes(asc_obj: &[u8], api_version: &$crate::semver::Version) -> Result<Self, $crate::errors::AscError> {
                // Sanity check
...
macro_rules! impl_asc_type_enum {
    ($enum_name:ident; $($variant_name:ident => $variant_index:tt),*) => {
        impl $crate::asc::base::AscType for $enum_name  {
            ...
            fn from_asc_bytes(asc_obj: &[u8], _api_version: &$crate::semver::Version) -> Result<Self, $crate::errors::AscError> {
